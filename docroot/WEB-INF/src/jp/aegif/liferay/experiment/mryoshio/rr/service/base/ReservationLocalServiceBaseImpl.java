...
/**
 * The base implementation of the reservation local service.
 * 
 * <p>
 ...
 * in
 * {@link jp.aegif.liferay.experiment.mryoshio.rr.service.impl.ReservationLocalServiceImpl}
 * .
 * </p>
 * 
 * <p>
 ...
 * @generated
 */
public abstract class ReservationLocalServiceBaseImpl implements
		ReservationLocalService {
	/**
	 * Adds the reservation to the database. Also notifies the appropriate model
	 * listeners.
	 * 
	 * @param reservation
	 ...
	 */
	public Reservation createReservation(int reservationId) {
		return reservationPersistence.create(reservationId);
	}

	/**
	 * Deletes the reservation with the primary key from the database. Also
	 * notifies the appropriate model listeners.
	 * 
	 * @param reservationId
	 *            the primary key of the reservation to delete
	 * @throws PortalException
	 *             if a reservation with the primary key could not be found
	 * @throws SystemException
	 *             if a system exception occurred
	 */
	public void deleteReservation(int reservationId) throws PortalException,
			SystemException {
		reservationPersistence.remove(reservationId);
	}

	/**
	 * Deletes the reservation from the database. Also notifies the appropriate
	 * model listeners.
	 * 
	 * @param reservation
	 ...
	 * 
	 * @param reservationId
	 *            the primary key of the reservation to get
	...
	/**
	 * Updates the reservation in the database. Also notifies the appropriate
	 * model listeners.
	 * 
	 * @param reservation
	 ...
	 *            the reservation to update
	 * @param merge
	 *            whether to merge the reservation with the current session. See
