...
/**
 * The base model implementation for the Reservation service. Represents a row
 * in the &quot;rr_Reservation&quot; database table, with each column mapped to
 * a property of this class.
 * 
 * <p>
 * This implementation and its corresponding interface
 * {@link jp.aegif.liferay.experiment.mryoshio.rr.model.ReservationModel} exist
 ...
 * reservation model instance should use the
 * {@link jp.aegif.liferay.experiment.mryoshio.rr.model.Reservation} interface
 * instead.
 * </p>
 * 
 ...
 * @generated
 */
public class ReservationModelImpl extends BaseModelImpl<Reservation> implements
		ReservationModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil
			.getBoolean(
					com.liferay.util.service.ServiceProps
							.get("value.object.entity.cache.enabled.jp.aegif.liferay.experiment.mryoshio.rr.model.Reservation"),
					true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil
			.getBoolean(
					com.liferay.util.service.ServiceProps
							.get("value.object.finder.cache.enabled.jp.aegif.liferay.experiment.mryoshio.rr.model.Reservation"),
					true);
	public static final long LOCK_EXPIRATION_TIME = GetterUtil
			.getLong(com.liferay.util.service.ServiceProps
					.get("lock.expiration.time.jp.aegif.liferay.experiment.mryoshio.rr.model.Reservation"));
	...
	public String toXmlString() {
		...
		sb.append("<column><column-name>reservationId</column-name><column-value><![CDATA[");
		sb.append(getReservationId());
		...
		sb.append(getOwnerId());
		sb.append("]]></column-value></column>");
		sb.append("<column><column-name>beginTime</column-name><column-value><![CDATA[");
		sb.append(getBeginTime());
		sb.append("]]></column-value></column>");
		sb.append("<column><column-name>endTime</column-name><column-value><![CDATA[");
		sb.append(getEndTime());
		sb.append("]]></column-value></column>");
		sb.append("<column><column-name>userId</column-name><column-value><![CDATA[");
		sb.append(getUserId());
		sb.append("]]></column-value></column>");
		sb.append("<column><column-name>note</column-name><column-value><![CDATA[");
		sb.append(getNote());
		sb.append("]]></column-value></column>");
